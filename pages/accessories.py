...
st.title("👜 Accessories Collection")
...
category_products = [
    p for p in products if p.category == "Accessories"
]
...
if not category_products:
    ...
    for i, product in enumerate(category_products):
        ...
        with cols[i % 3]:
            ...
            # Product Image
            st.write("Image path:", product.image)
            st.write("Exists:", os.path.exists(product.image) if product.image else False)
